   ...
   const [loading, setLoading] = useState(false);
    ...
    const {values ,handleSubmit, handleChange,setFieldValue,errors,setErrors} = useFormik({
        initialValues: {
            ...
            phone: dealer.phone,
            image: dealer.avatar,
            active: Boolean(dealer.active),
            reset_password: false,
            password: '',
            password_confirmation: ''
        },
        validationSchema: Yup.object().shape({
            name: Yup.string().required('Bayi Adı Zorunludur.'),
        ...
        onSubmit: values => {
            ...
            fetch(route('central.dealers.update',dealer.id), {
                method: 'POST',
                headers: {
        ...
        <form className="p-fluid" onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-x-3 mb-3">
                ...
                <div className={"col-span-2"}>
                    <label htmlFor="name" className="font-bold">
                        Bayi Adı <span className={"font-semibold text-red-400"}>*</span>
                    </label>
            ...
            <div className={"mb-3"}>
                <label htmlFor="email" className="font-bold">
                    Bayi E-Posta Adresi <span className={"font-semibold text-red-400"}>*</span>
                </label>
                <InputText id="email" type={"email"} name={"email"} onChange={handleChange} value={values.email}/>
            </div>
            <div className={"mb-3"}>
                <label htmlFor="phone" className="font-bold">
                    Bayi Admin Telefon No <span className={"font-semibold text-red-400"}>*</span>
                </label>
            ...
            <div className="mb-3 flex justify-start items-center gap-x-2">
                <InputSwitch checked={values.active} inputId={"dealerActive"} onChange={(e) => setFieldValue('active',e.value)} />
            ...
            {values.reset_password && <div className={"mb-3 grid grid-cols-2 gap-x-3"}>
                <div>
                    <label htmlFor="password" className="font-bold">
                        Bayi Yetkili Şifre <span className={"font-semibold text-red-400"}>*</span>
                    </label>
                ...
                <div>
                    <label htmlFor="password_confirmation" className="font-bold">
                        Bayi Yetkili Şifre Onayla<span className={"font-semibold text-red-400"}>*</span>
                    </label>
