...
export default function Update({
    ...
    const [activeRole, setActiveRole] = useState(roles.find(role => role.role === user.role));
    ...
    const {values ,handleSubmit, handleChange,setFieldValue,errors,setErrors} = useFormik({
        ...
        onSubmit: values => {
            ...
            fetch(route('super.central.update',user.id), {
                method: 'POST',
                headers: {
    ...
    return (<BlockUI blocked={loading} template={<i className="pi pi-spin pi-spinner" style={{fontSize: '3rem'}}></i>}>
        <form className="p-fluid" onSubmit={handleSubmit}>
            ...
            <div className="mb-3 flex justify-start items-center gap-x-2">
                <InputSwitch checked={values.active} inputId={"userActive"} onChange={(e) => setFieldValue('active',e.value)} />
                <label htmlFor="userActive" className="font-bold">
