...
export default function Create({categories, csrf_token, toast, onHide, setProducts, setAddModalFooter,addModal}) {
    ...
    const {values ,handleSubmit, handleChange,setFieldValue,errors,setErrors} = useFormik({
        ...
        onSubmit: values => {
            if (skuCodeResponse && !skuCodeResponse.status) {
                ...
                fetch(route('super.products.store'), {
                    method: 'POST',
                    headers: {
    ...
    const controlSkuCode = (e) =>   {
        ...
        if (e.target.value === skuCodeResponse.sku) {
            return false;
        }
        setSkuCodeControl(true);
        fetch(route('super.products.controlSku'), {
            method: 'POST',
            headers: {
        ...
        <form className="p-fluid"  onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
                <div className="field">
                    ...
                    <InputNumber id="price" mode="currency" name={"price"} onChange={(e) => {
