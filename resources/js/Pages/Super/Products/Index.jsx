...
import Create from "@/Pages/Super/Products/Create.jsx";
import Update from "@/Pages/Super/Products/Update.jsx";
import ProductCodes from "@/Pages/Super/Products/ProductCodes.jsx";
...
export default function Index({auth, productsAll, categoriesAll, csrf_token}) {
    ...
    const prepareShowCodes = (product) => {
