...
import NewWorker from "@/Pages/Super/Dealers/Pages/NewWorker.jsx";
import Workers from "@/Pages/Super/Dealers/Pages/Workers.jsx";
import Services from "@/Pages/Super/Dealers/Pages/Services.jsx";
import Customers from "@/Pages/Super/Dealers/Pages/Customers.jsx";
...
const Index = (props) => {
    ...
    const handleRoute = (action) => {
        router.visit(route('super.dealers.show', dealer.id), {
            method: "get",
            data: {
                subRoute: action
            }
